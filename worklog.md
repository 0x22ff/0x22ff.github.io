...
<section class="v-worklog">
  ...
  <header class="wl-header">
    <h1>작업일지 Timeline</h1>
    <p>Private 저장소의 Task 문서를 외부에서도 읽기 쉽게 정리한 타임라인입니다. 기능 추가, 리팩터링, 배포까지 흐름으로 확인할 수 있게 구성했습니다.</p>
    <div class="wl-stats"><span>Task 37개</span><span>기간 2024-12-25 ~ 2026-02-24</span><span>최신 2026-02-24</span></div>
  </header>

  <section class="wl-project">
    <p class="wl-project-label">프로젝트</p>
    <div class="wl-project-tabs" role="tablist" aria-label="project tabs">
      <button class="active" type="button" role="tab" aria-selected="true">BSSJ</button>
    </div>
  </section>
